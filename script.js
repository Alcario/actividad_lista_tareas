function agregarTarea() {
  ...
  if (nuevaTareaTexto !== "") {
    ...
    nuevaTarea.addEventListener("click", function () {
      marcarCompletada(nuevaTarea); // Marca como completada al hacer clic en el elemento
    });
...
function mostrarCompletadas() {
  ...
  tareas.forEach((tarea) => {
    if (tarea.classList.contains("completed")) tarea.style.display = "flex";
...
function mostrarPendientes() {
  ...
  tareas.forEach((tarea) => {
    tarea.style.display = ""; // Restablece el estilo de visualización
...
//Agregar evento de click al botón "Mostrar Completadas"
document
  .getElementById("mostrarCompletadas")
  .addEventListener("click", mostrarCompletadas);

//Agregar evento de click al botón "Mostrar Pendientes"
document
